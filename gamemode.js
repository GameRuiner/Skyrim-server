...
exports.professionSystem = {
  ...
  delete: function (formId, professionName) {
    utility_1.utils.log('[PROFESSIONS]', 'deleteProfession');
    var isDeleted = exports.professionSystem.deleteItems(formId, professionName);
  ...
  deleteItems: function (formId, professionName) {
...
var activatorIdToGetProf = 0x1f229;
...
},{"./professionSystem":"systems/professionsSystem/professionSystem.ts","./minesSystem":"systems/professionsSystem/minesSystem.ts","./woodsmanSystem":"systems/professionsSystem/woodsmanSystem.ts","./farmSystem":"systems/professionsSystem/farmSystem.ts"}],"systems/index.ts":[function(require,module,exports) {
"use strict";
